...
class Work extends Component {
	render(){
		return(
		<div className="Work">
			<span className="route-header" >WORK</span>
			<div className="route-container-work">
				<div className="work-photo-container">
					<div className="work-photo-1 work-photo"></div>
					<div className="work-photo-2 work-photo"></div>
					<div className="work-photo-3 work-photo"></div>
					<div className="work-photo-4 work-photo"></div>
				</div>
				</div>
